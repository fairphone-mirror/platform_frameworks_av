    ...
    mInitialized(false)
    {
        ...
        if (sessionId >= 0) {
            ...
            mEffect = new AudioEffect(
                OZO_STEREO_EFFECT_TYPE, String16("OzoPlaybackController"), OZO_STEREO_EFFECT_UUID,
...
static inline void tryOzoAudioConfigure(const sp<AMessage> &format, AString &mime, sp<OzoPlaybackController> &playCtrl)
{
    sp<ABuffer> csd;
